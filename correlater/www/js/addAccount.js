...
$(document).on('deviceready', function() {
  ...
  $loginButton.on('click', function() {
    googleapi.authorize({
      ...
      scope: 'profile email https://www.googleapis.com/auth/calendar.readonly https://www.googleapis.com/auth/contacts.readonly https://www.googleapis.com/auth/plus.login'
      // scope: 'profile email'
