...
var openFB = (function () 
{
    ...
    var FB_LOGIN_URL = 'https://www.facebook.com/dialog/oauth',
        ...
        baseURL = "https://www.facebook.com/connect/login_success.html",//location.protocol + '//' + location.hostname + (location.port ? ':' + location.port : '') + context,
...
//        logout();
    ...
    function oauthCallback(url) {
        ...
        if (url.indexOf("access_token=") > 0) {
            ...
            localStorage.setItem("fbtoken", obj['access_token']);
